...
public class CalculatorView extends JFrame {
	...
	private void initBtnPanel() {
		...
		*/
		...
		btnStr.add(CalUtils.sqrtStr);
		btnStr.add(CalUtils.powStr);
		*/
	...
	private void initDisplayPanel() {
		...
		gbc.weightx = 1.0;
		gbc.weighty = 1.0;
		expLbl = new JLabel("0", SwingConstants.RIGHT);
		expLbl.setVerticalAlignment(SwingConstants.BOTTOM);
		expLbl.setFont(new Font("Tahoma", Font.BOLD, 50));
		displayPanel.add(expLbl, gbc);
		
		gbc.gridx = 0;
		gbc.gridy = 0;
		preLbl = new JLabel("", SwingConstants.RIGHT);
		preLbl.setVerticalAlignment(SwingConstants.BOTTOM);
		preLbl.setFont(new Font("Tahoma", Font.BOLD, 30));
